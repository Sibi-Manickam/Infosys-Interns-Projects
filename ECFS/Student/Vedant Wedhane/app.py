...
# laoding the data
data_log = pd.read_csv(r'D:\MASTER\Courses\Infosys AI\Project\Time-Series-Forecasting-main\energy_consumption.csv')



# Load all model files
arima_model = pickle.load(open(r'D:\MASTER\Courses\Infosys AI\Project\Time-Series-Forecasting-main\arima_model.pkl', 'rb'))
ets_model = pickle.load(open(r'D:\MASTER\Courses\Infosys AI\Project\Time-Series-Forecasting-main\ETS_model.pkl', 'rb'))
